...
try:
    ...
    os.system('pip install collections && cls')
    import collections
...
try:
    ...
    os.system('pip install ssl && cls')
    from ssl import PROTOCOL_TLSv1_2

try:
    from urllib3 import PoolManager
except:
    os.system('pip install urllib3 && cls')
    from urllib3 import PoolManager
...
class valorant:
    ...
    def update_title(self):
        os.system(clear)
        self.change_title("Valorant Keker | Github: https://github.com/mukitan")
    ...
    def create_folders(self):
        ...
        print(f"{Fore.WHITE}[{Fore.GREEN}-{Fore.WHITE}] https://github.com/mukitan")
